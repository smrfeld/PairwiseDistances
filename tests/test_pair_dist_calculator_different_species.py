...
class TestDifferentSpecies:
    ...
    def test_remove_all_particles_of_species_A(self):
        ...
        pdc.remove_all_particles_of_species_A()

        assert pdc.n_species_A == 0
        assert pdc.n_species_B != 0
        assert pdc.no_pairs == 0
        assert pdc.no_pairs_within_cutoff == 0

    def test_remove_all_particles_of_species_B(self):
        ...
        pdc.remove_all_particles_of_species_B()

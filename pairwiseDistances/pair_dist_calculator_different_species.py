...
class PairDistCalculatorDifferentSpecies:
    ...
    def __init__(self, posns_species_A, posns_species_B, dim, cutoff_distance=None, track_labels=False, labels_species_A=np.array([]), labels_species_B=np.array([]), calculate_track_centers=False):
    ...
    def _cut_off_distances(self):
        ...
        if self._cutoff_distance != None:
            ...
            self._idxs_first_particle_of_species_A_within_cutoff, self._idxs_second_particle_of_species_B_within_cutoff, _ = stacked[stacked[:,2] < cutoff_distance_squared].T
    ...
    def _add_particle(self, idxs_add_of_species_A, idxs_add_of_species_B):
        ...
        if self._cutoff_distance != None:
            ...
            idxs_add_of_species_A, idxs_add_of_species_B, dists_squared_add = stacked[stacked[:,2] < cutoff_distance_squared].T
    ...
    def get_particle_idxs_of_species_B_within_cutoff_distance_to_particle_of_species_A_with_idx(self, idx):
    ...
    def get_particle_idxs_of_species_A_within_cutoff_distance_to_particle_of_species_B_with_idx(self, idx):
